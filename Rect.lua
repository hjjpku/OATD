...
function Rect.Shape_similarity(a,b)
  local ratio1 = (a.maxX-a.minX)/(a.maxY-a.minY)
  local ratio2 = (b.maxX-b.minX)/(b.maxY-b.minY)
  local area1 = (a.maxX-a.minX)*(a.maxY-a.minY)
  local area2 = (b.maxX-b.minX)*(b.maxY-b.minY)
  if ratio1 > ratio2 then
    if area1 > area2 then
      return ratio2/ratio1*area2/area1
    else
      return ratio2/ratio1*area1/area2
    end
  else
    if area1 > area2 then
      return ratio1/ratio2*area2/area1
    else
      return ratio1/ratio2*area1/area2
    end
  end
end
